...
**No macOS, na primeira abertura** o sistema vai bloquear o app dizendo que
não é de um desenvolvedor identificado — o app não é assinado digitalmente.
Vá em *Ajustes do Sistema → Privacidade e Segurança*, role até o aviso sobre o
ProShow e clique em **Abrir mesmo assim**.
