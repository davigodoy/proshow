...
**Já compilado:** baixe Mac / Windows / Linux em
[Releases](https://github.com/davigodoy/proshow/releases) (ex.: **v0.1.6**).

Para gerar você mesmo, rode o comando do **seu** sistema:
...
**No macOS, na primeira abertura** o sistema costuma avisar que o desenvolvedor
não está identificado — o release público usa assinatura **ad-hoc**, **não**
notarização da Apple (não pede certificado seu; só o aviso do Gatekeeper).
Clique com o botão direito → **Abrir**, ou em
