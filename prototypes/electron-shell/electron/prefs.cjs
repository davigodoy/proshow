...
const DEFAULTS = {
  ...
  /** Posição/tamanho da janela do operador (restaurados ao reabrir). */
  operatorBounds: null,
};
...
function normalizeOperatorBounds(raw) {
...
function normalize(p) {
  return {
    ...
    operatorBounds: normalizeOperatorBounds(p.operatorBounds),
  };
}
