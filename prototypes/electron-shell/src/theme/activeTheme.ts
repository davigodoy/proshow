...
export function resolveActiveTheme(
  ...
  return {
    ...
    showTitle: o.showTitle !== undefined ? o.showTitle : base.showTitle,
    showArtist: o.showArtist !== undefined ? o.showArtist : base.showArtist,
    showLyrics: o.showLyrics !== undefined ? o.showLyrics : base.showLyrics,
