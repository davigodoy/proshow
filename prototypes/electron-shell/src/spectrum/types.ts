...
export const SPECTRUM_STYLES: Array<{
  ...
  { id: 'aurora', label: 'Aurora', hint: 'Véus de luz que preenchem a tela' },
  { id: 'horizon', label: 'Horizonte', hint: 'Montanhas de energia do chão' },
  { id: 'halo', label: 'Halo', hint: 'Raios suaves do centro' },
  { id: 'ember', label: 'Brasa', hint: 'Colunas e partículas quentes' },
...
/**
 * Em câmera ao vivo (programa) ou mídia visual full-bleed, o espectro vira
 * barra inferior — sem gravar a preferência. Áudio (mp3/…) não tem quadro
 * próprio: respeita o placement (fundo = tela cheia). Câmera de fundo
 * (letra/bíblia com cam atrás) também mantém o placement escolhido.
 */
